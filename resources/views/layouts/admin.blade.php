    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-nav-link :href="route('admin.trainings.index')" :active="request()->routeIs('admin.trainings.index')">
                    {{ __('Trainings') }}
                </x-admin-nav-link>
                <x-admin-nav-link :href="route('admin.canoes.index')"
                    :active="request()->routeIs('admin.canoes.index')">
                    {{ __('Canoes') }}
                </x-admin-nav-link>
